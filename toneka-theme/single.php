	...
	?>
		...
		<?php while ( have_posts() ) : ?>
			...
			<div class="toneka-hero-section">
			    <div class="toneka-hero-left">
			        ...
			        <div class="toneka-hero-content">
			            ...
			            <!-- Ikona kategorii -->
			            <div class="toneka-category-icon">
			            ...
			            <!-- Przycisk posłuchaj -->
			            <button class="toneka-listen-button animated-arrow-button">
			                <span class="button-text">POSŁUCHAJ</span>
			...
			<div class="toneka-product-info-section">
			    ...
			    <div class="toneka-audio-section">
