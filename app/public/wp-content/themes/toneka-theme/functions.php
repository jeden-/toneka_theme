...
function toneka_footer_widgets_init() {
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Post Sidebar', 'tonekatheme' ),
			'id'            => 'post-sidebar',
			'description'   => esc_html__( 'Add widgets here to appear in the sidebar on single post pages.', 'tonekatheme' ),
        ...
        <div class="toneka-bottom-panel">
            ...
            <div class="toneka-bottom-controls">
                ...
                <div class="toneka-right-controls">
                    ...
                    <button class="toneka-control-btn toneka-fullscreen" style="display: none;">
                        <svg width="17" height="17" viewBox="0 0 24 24" fill="white">
